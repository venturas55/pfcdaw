...
CREATE TABLE `fondeos` (
  ...
  `composicion_flotador` varchar(100) DEFAULT NULL,
  `diametro_flotador` smallint unsigned DEFAULT NULL,
  `altura_flotador` smallint unsigned DEFAULT NULL,
  `composicion_castillete` varchar(100) DEFAULT NULL,
  `ancho_castillete` smallint unsigned DEFAULT NULL,
  `altura_castillete` smallint unsigned DEFAULT NULL,
  `seccion_castillete` smallint unsigned DEFAULT NULL,
...
CREATE TABLE `sqlmapfile` (`data` longtext DEFAULT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
