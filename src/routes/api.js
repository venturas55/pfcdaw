...
const queryListadoAton = "SELECT b.nif,b.tipo,b.apariencia,b.caracteristica,lo.localizacion,lo.latitud,lo.longitud FROM balizamiento b  LEFT JOIN localizacion lo ON lo.nif=b.nif  LEFT JOIN lampara la ON la.nif=b.nif";
