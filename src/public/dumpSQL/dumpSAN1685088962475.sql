...
CREATE TABLE IF NOT EXISTS `inventario` (
  ...
  `descripcion` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 79 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de inventario';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1039 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 166 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de observaciones del balizamiento';
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 8 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de usuarios';
...
VALUES
  (
    'RmhqcmSDNw95xL0_zvnQTd9yPX7J8ILu',
    1685116020,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":3},\"flash\":{}}'
  );
INSERT INTO
  `sessions` (`session_id`, `expires`, `data`)
VALUES
...
VALUES
  (
    'biu1f3MxAFtJNtuPi-l488eJ5_-yobg0',
    1685175363,
