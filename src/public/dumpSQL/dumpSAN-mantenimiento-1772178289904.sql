...
) ENGINE = InnoDB AUTO_INCREMENT = 1348 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 298 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de observaciones del balizamiento';
...
VALUES
  (
    ...
    '25554',
    '2011-10-26',
    'Revisión general de la boya. Todo correcto'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1061, 'reserva3', '2023-04-14', 'Boya fondeada.');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1062, 'reserva5', '2023-04-14', 'Boya fondeada.');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1063, 'reserva9', '2023-04-14', 'Boya fondeada.');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1064, 'reserva4', '2023-04-14', 'Boya fondeada.');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25721',
    '2024-04-09',
    'Se cambia batería (180Ah), la anterior batería era de diciembre 2018'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25650',
    '2024-02-20',
    'se instala SAI para AIS y SAI para equipos informatica Tunel ADSL'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-03-12',
    'Se repara el tramo final de barandilla para aceder a linterna principal se ha descolgado'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26390',
    '2024-04-10',
    'Se sustituye el regulador y sigue sin telecontrol'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-04-16',
    'Se cambian bombillas escalera acceso torre'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25721',
    '2024-04-16',
    'Se instala cargador externo, debido a bajada de tensión de la bateria '
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25721',
    '2024-04-18',
    'Se desinstala el cargador externo y se cambia fusible alimentación de bateria, se deja en observación para comprobar la carga y descarga de la bateria'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-05-06',
    'Se instala una boya de sustitución con MCL100'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-05-07',
    'Se da de alta en el Portal ATON'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26390',
    '2024-05-08',
    'Se sustituye la LDR de la linterna y se subsana el cableado del panel solar.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26290',
    '2024-05-20',
    'Se pinta correspondiente al 2023.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26285',
    '2024-05-21',
    'Se pinta a razón de 2023 y se encuentran daños serios estructurales por oxidación.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25700',
    '2015-07-16',
    'Entra en servicio el nuevo Faro.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25700',
    '2024-05-28',
    'Se averia el escalon superior de LEDs de la baliza principal, se pasa a funcionamiento con servicio reducido.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25554',
    '2024-06-06',
    'Se traslada la boya 25554 para su mantenimiento integral en tierra, habiendo fondeado una boya de sustitución de  similares características'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25554',
    '2024-06-07',
    'Se fondea la boya pintada, comprobando su correcto funcionamiento'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26500',
    '2024-06-19',
    'Se realiza la revisió del GE por parte de FINANZAUTO, pasaran a cambiar filtros'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25920',
    '2024-06-20',
    'Fallo de tensión 220V (Alimentación general) Debido a corte en el CT-11 por mantenimiento. La batería responde correctamente (flotación 13.46V)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25940',
    '2024-06-20',
    'Fallo de tensión 220V (Alimentación general) Debido a corte en el CT-11 por mantenimiento. La batería responde correctamente (flotación 13.14V)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-06-20',
    'Se recupera la boya perdida en la Pobla de Farnals y se sustituye por la provisional (le falta la marca de tope)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25850',
    '2024-06-14',
    'Fallo de tensión 220V (Alimentación general) Debido a disparo ID general cuadro telecontrol. La batería responde correctamente (flotación 13.33V)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.1',
    '2024-06-24',
    'Se da de baja por desaparición a la deriva. Aunque ya ha aparecido, se fondeó en le lugar de la 26450-g.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25700',
    '2024-06-25',
    'Se desconecta MTU-100 (Envio persistente de alarma fallo LEDS)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25552',
    '2024-06-26',
    'Fallo de tensión 220V (Alimentación general) Debido a disparo ID general cuadro telecontrol. La batería responde correctamente (flotación 13.48V)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26314',
    '2024-07-01',
    'Se rearma el diferencial que alimenta la baliza, conjuntamente con los focos, desde el cuadro de baja en el transformador.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.1',
    '2024-07-03',
    'Se pone la boya original encontrada.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.9',
    '2024-07-03',
    'Se da de baja por desaparición.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25800',
    '2024-06-13',
    'Sustitución de bateria 13/06/2024'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25700',
    '2024-07-09',
    'Estuvo de baja dos dias por fallo en los dos pisos de LEDs de la baliza principal.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25720',
    '2024-07-16',
    'Fallo de tensión 220V (Alimentación general) Debido a corte en el CT por mantenimiento. La batería responde correctamente (flotación 13.38V)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25700',
    '2024-07-10',
    'Se realiza la sustitución de los dos escalones LED y se cambian los tacos de los dos niveles, al instalarse escalones de diferente altura a los anteriores. Se realiza el repriete del casquillo de conexión a la lampara BAEM. '
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25700',
    '2024-07-10',
    'Se da de alta en portalAton tras comprobarse su correcto funcionamiento.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.9',
    '2024-07-11',
    'Se repone con boya de sustitución más pequeña, de almarin.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25665',
    '2024-07-18',
    'Se realiza inspeccion semestral. Se cambia baliza por modelo MPM24 con aletas de marca diurna.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25545',
    '2024-07-26',
    'Comprobación de funcionamientocorrecto del sistema y pruebas de comunicación SCADA. Se revisa corona de LEDS observando alguno deteriorado, sin importacia para el alcance en general'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25552',
    '2024-07-26',
    'Comprobación de funcionamientocorrecto del sistema y pruebas de comunicación SCADA      '
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25570',
    '2024-07-26',
    'Comprobación de funcionamientocorrecto del sistema. Revision de discos LEDS, uno de los discos falla por mal contacto se realiza repriete dejandolo en funcionamiento'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25565',
    '2024-07-26',
    'Comprobación de funcionamientocorrecto del sistema. Se revisan discos de LEDS observando alguno deteriorado, sin importacia para el alcance en general'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25555',
    '2024-07-26',
    'Comprobación de funcionamiento correcto del sistema: Existe acumulación de humedad en la linterna'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-07-22',
    'Derribo muro exterior parte superior sur por accidente de trafico'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-07-23',
    'Toma de muestra agua por empres AMBICAI . Comprobación correcto funcionamiento faro'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    'reserva1',
    '2024-08-07',
    'Revision submarina a cargo de Wartsila'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25842.5',
    '2024-08-16',
    'Wartsila realiza revisión submarina. Desgaste cadena medio de 16mm.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25765',
    '2024-09-03',
    'Revision anual fondeo a cargo de Wartsila'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26313',
    '2024-09-06',
    'La pontona  le pega un golpe rompiendo el cuadro de la electrónica quedando esta al descubierto.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26313',
    '2024-09-10',
    'Amarradores nos hace el favor de tapar el cuadro con cinta y bridas que les he suministrado.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25545',
    '2024-09-11',
    'Se realiza un reset en el moscad debido a que la linterna esta encendida, en SACADA aparece encendida en modo manual sin motivo'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25564',
    '2024-09-11',
    'Sin acceso a baliza debido a desaparición primer tramo flotante pantalan (Septiembre 2024)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25555',
    '2024-09-11',
    'Se realiza reparación de cerradura'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25721',
    '2024-09-16',
    'Rearme de IA en CT (alimentacion general) Preaviso fallo de rectificador en SCADA'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-09-17',
    'Cambio de bombillas linterna principal '
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26451',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 14mm.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.1',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Tramos nuevos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.2',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 18mm'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.3',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 11mm'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.4',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 10mm'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26450.6',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 21mm. 9m de durmiente con 6 enterrados.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Tiene una reparación a 4m de la boya. durmiente de 5m.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.8',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Se detecta un diametro minimo de 17mm. A 5m de boya  grillete de 16mm'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.9',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. Cadena nueva. 6m de durmiente.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450',
    '2024-07-11',
    'Revisión extraordinaria del tren de fondeo. 45 m de cadena hasta muerto. Sin desgaste.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26450.9',
    '2024-10-01',
    'Revisión no realizada pues fue sustituida recientemente.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-10-01',
    'Revision no realizada pues fue sustituida recientemente.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26451',
    '2024-10-01',
    'Se recorta 1m de cadena para enmendar el desgaste máximo de 14mm.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.5',
    '2024-10-01',
    'Se enmenda tramo de cadena pues presentaba 11mm de desgaste maximo.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26450.3',
    '2024-10-04',
    'se enmenda cadena para resolver desgaste máximo.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25530',
    '2024-10-24',
    'Se reconfigura la sensibilidad de la fotocelula a su valor normalizado: BAJA SENSIBILIDAD'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25552',
    '2024-10-21',
    'Fallo de tensión 220V ( Se cambia fusible de rectificador C20)'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26450.7',
    '2024-10-24',
    'Se sustituye por la boya original.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-04',
    'Se da  de baja portal ATON fallo linterna y AIS'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-05',
    'Se comprueba la ausencia de tensión en una de las 3 fases debido a averia en fusible del CT de Iberdrola. Se comunica a Iberdrola para su reposición. Se comprueba ausencia de tensión en la batería del GE.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-06',
    'Tras la reposición del fusible por parte de Iberdrola se comprueba que la tensión en la acometida sigue sin llegar correctamente. Se verifica que es debido por la averia del contador en cabecera. Se avisa a Iberdrola y se sustituye contador. '
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-06',
    'Se comprueba la alimentación y se pone en funcionamiento del faro. Se da de alta en portal ATON la ayuda luminosa dejando el AIS de baja por averia en el switch de comunicaciones'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-07',
    'Se realizan pruebas en GE y conmutacion RED / GE (Cuadro ATI). Se sustituye bateria del GE. Se comprueba que el cargador de la bateria esta cortocicuitado. Queda pendiente su reposición por parte de taller movil y SE'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-06',
    'Se comprueba que el cuadro de protecciones contra sobretensiones a quedado dañado y en averia. Se instala un IA provisional en el mismo cuadro para dar servicio y puentear la proteccion de sobretensiones averiada.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26190',
    '2024-11-06',
    'Se sustituye por boya de sustitución con MCL200 (doble corona) para realizar trabajos de adaptación a la nueva linterna con comunicacion GPRS'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26290',
    '2024-09-26',
    'Se reparan los pilares del vallado. Falta pintarlos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    'reserva1',
    '2024-11-29',
    'Se desplaza 150m al norte de 39º 27.155´N y 00º 18.042\' W a  39º 27.244\' N 000º 18.005\' W por motivo de las obras en la darsena norte.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    'reserva2',
    '2024-11-29',
    'Se desplaza 150m al norte de 39º 27.104´N y 00º 17.882\' W a  39º 27.199\' N 000º 17.834\' W por motivo de las obras en la darsena norte.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26190',
    '2024-12-04',
    'Se instala la boya original modificada para una linterna MCL360 telecontrolada por tarjeta SIM..'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-11-12',
    'Se repara e instala el cargador de la bateria GE (Puente de diodos averiado y sustituido).'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-12-03',
    'Comienzan trabajos de aislamiento ventanas, tejas y fachada'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26052',
    '2024-11-18',
    'Se da  de baja portal ATON fallo linterna debido a batería en mal estado'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26052',
    '2024-11-20',
    'Se sustituye bateria por una de menor capacidad y se da de alta en portal ATON tras comprobar su funcionamiento'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25650',
    '2024-12-17',
    'Se cambia la fuente de alimentacion del cuadro SCADA. La caida del termico 20Q4 provoca que no encienda el faro.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    'reserva2',
    '2024-12-19',
    'Se desplaza de 39º 17.956\' N 000º 17.882\' W a 39º 27.176\' 0º 18.096\'W por motivo de las obras en la darsena norte.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    'reserva1',
    '2024-12-19',
    'Se desplaza de 39º 27.176´N y 00º 18.005\' W a  39º 27.244\' N 000º 18.096\' W por motivo de las obras en la darsena norte.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25761',
    '2024-12-12',
    'Se enmenda cadena que tenia 10 eslabones desgastados y sustituyen anodos'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25765',
    '2024-12-17',
    'Se enmenda durmiente que estaba a 41mm entre eslabones y se sustituyen anodos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25820.1',
    '2024-12-17',
    'Se libera cadena del fondo y se sustituyen ánodos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25841',
    '2024-12-17',
    'Se libera la cadena y se sustituyen los ánodos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25842.5',
    '2024-12-27',
    'Se enmienda la durmiente y se sustituyen los ánodos.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26047',
    '2025-01-23',
    'Por obras se modifica a Cardinal Este según resolucion de balizamiento provisional VA13.07'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26046.9',
    '2025-01-19',
    'Se fondea y entra en funcionamiento la nueva boya según resolución de balizamiento provisional VA13.07'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25778.5',
    '2025-01-21',
    'Se traslada la batea y se pone en funcionamiento la ayuda según resolución VA13.05'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '26046.7',
    '2025-02-03',
    'Se sustituye el muerto colocando uno de 5Tn'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26046.9',
    '2025-02-02',
    'Se sustituye el muerto colocando uno de 5Tn segun proyecto.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '25740',
    '2025-02-22',
    'Tras aviso por parte del CCE se sustituye la linterna por una MCL360M nueva por fallo en los destellos'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    '25843',
    '2025-03-06',
    'sustitución de batería por deterioro'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26320-a',
    '2024-09-03',
    'Se fondea según resolución de balizamiento provisional'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (
    ...
    '26053.5',
    '2025-02-17',
    'Entra en servicio como emplazamiento de la resolucion provisional de Bateas'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
VALUES
  (
    ...
    'reserva1',
    '2025-01-24',
    'Se retiran y se dan de baja del balizamiento, por obras darsena norte.'
  );
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1342, '25470', '2025-05-14', 'Se repita el aton');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1345, '25920', '2026-02-13', 'zv');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1346, '25700', '2026-02-04', 'scdxv');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1347, '26047', '2026-02-18', 'asdasd');
...
VALUES
  (
    31,
    '25700',
    'PANELES 95/12V --- BATERIAS:720Ah - 24v --- AEROGENERADOR: WS-0.15b 132W/24V '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (75, 'reserva8', ' SE REPINTARÁ EN 2019');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (76, 'reserva8', 'Entra en servicio el 26/06/2013');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (78, 'reserva7', 'Entra en servicio el 06/06/2013');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (80, 'reserva1', 'Sincronizada con 26048.3');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (81, 'reserva2', 'Entra en sevicio el 31/05/2013');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (82, 'reserva2', 'Sincronizada con  26048.2');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
VALUES
  (
    117,
    '26320',
    'Se ve con la camara \'Regasificadora\''
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
VALUES
  (
    157,
    '26450',
    'Antigua ubicacion de la baliza. 39º38.803\'N 0º 11.664\'W'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (158, 'reserva7', 'Desconectado el RTU por rayo');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (188, '26450.7', 'Durmiente: 5m aproximadamente');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (189, '25721', 'Fallos en carga de batería 04/24');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (190, '25554', 'Requiere ser pintada en 2024');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (191, '25530', 'Requiere ser pintada en 2024');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (192, '25730', 'PLANO FOCAL...5M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (193, '25740', 'Altura focal=6,60m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (194, '25761', 'PLANO FOCAL 5,70M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (195, '25765', 'PLANO FOCAL 5,70M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (196, '25768', 'PLANO FOCAL 5,40M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (197, '25805', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (198, '25806', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (199, '25820.1', 'PLANO FOCAL  5,80M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (200, '25841', 'PLANO FOCAL 5,80M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (201, '25842.5', 'PLANO FOCAL 1,62m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (202, '25843', 'PLANO FOCAL 3m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (203, '25843.5', 'PLANO FOCAL 1,62m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (204, '25843.8', 'PLANO FOCAL 1,62m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (205, 'reserva5', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (206, 'reserva9', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (207, 'reserva4', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (208, 'reserva4', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (209, 'reserva3', 'PLANO FOCAL 2,20M');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (210, 'reserva1', 'PLANO FOCAL...6,50m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (211, 'reserva2', '');
...
VALUES
  (
    212,
    '25650',
    'Se programa para septiembre el cambio de bombillas linterna principal'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    213,
    '26450.1',
    'La cadena de 23mm de grosor a unos 15 metros tiene un empalme con grillete a una cadena nueva. No se observan desgastes.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (214, '26450.1', 'Profundidad fondo natural: 17.3m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    215,
    '26450.1',
    'Profundidad parte superior muerto:16.6m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    216,
    '26450.1',
    'Metros de cadena hasta muerto:21m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (217, '26450.2', 'Profundidad fondo natural: 17.2m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    218,
    '26450.2',
    'Profundidad parte superior muerto:16.8m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    220,
    '26450.2',
    'Partiendo del contrapeso a 14.5m se observa un empalme con grillete de la cadena que estaba desgastado anteriormente. '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    221,
    '26450.2',
    'De durmiente hasta el muerto hay 10m aproximadamente de cadena de los cuales en los últimos 3m hay un empalme de cadena de 3m y 18mm de diámetro sin desgaste.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (222, '26450.2', 'Diámetro cadena: 23mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (223, '26450.3', 'Diámetro cadena: 23mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    224,
    '26450.3',
    'Desgaste máximo: 11mm en tramo de 3m a unos 14m del contrapeso'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    225,
    '26450.3',
    'Metros de cadena hasta muerto:26m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    226,
    '26450.3',
    'Durmiente: 3m + 3m alrededor del muerto'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (227, '26450.3', 'Profundidad fondo natural: 16.3m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    228,
    '26450.3',
    ' Profundidad parte superior muerto:15.6m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    229,
    '26450.3',
    'Muerto enterrado: Apoyado de lado'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (230, '26450.4', 'Diámetro cadena: 24mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    231,
    '26450.4',
    'Desgaste máximo: A 13.5m del contrapeso un tramo de 3m de la cadena tiene un diámetro de 10mm de espesor.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    232,
    '26450.4',
    'Metros de cadena hasta muerto:18m aproximadamente'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (233, '26450.4', 'Durmiente: 5m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    234,
    '26450.4',
    'Profundidad fondo natural: 16.1m '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    235,
    '26450.4',
    'Profundidad parte superior muerto:15.8m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    236,
    '26450.4',
    'Muerto enterrado: Enterrado un 20%'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    237,
    '26450.4',
    'Conexión muerto con cadena: Grillete 34mm y arganeo de 20mm sin desgaste'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (238, '26450.5', 'Diámetro cadena: 23mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    239,
    '26450.5',
    'Desgaste máximo: 11mm zona mas desgsatada'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    240,
    '26450.5',
    'Metros de cadena hasta muerto:22m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (241, '26450.5', 'Durmiente: 7m aproximadamente');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (242, '26450.5', 'Profundidad fondo natural: 15m ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    243,
    '26450.5',
    'Profundidad parte superior muerto: 14.4m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (244, '26450.5', 'Muerto enterrado: No');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    245,
    '26450.5',
    ' Conexión muerto con cadena: Grillete'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (246, '26450.6', 'Diámetro cadena: 26mm ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    247,
    '26450.6',
    'Desgaste máximo: A 3m del fondo empieza a desgastarse la cadena con diámetro de 21mm'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    248,
    '26450.6',
    'Metros de cadena hasta muerto: 9m hasta durmiete de los cuales 6m están enterrados.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    249,
    '26450.6',
    'Tramos reparados: Un tramo en la parte inferior de la durmiente.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    250,
    '26450.6',
    'Profundidad fondo natural: 15.2m '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    251,
    '26450.6',
    'Profundidad parte superior muerto:14.8m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    252,
    '26450.6',
    'Muerto enterrado: Al 60% enterrado'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    253,
    '26450.6',
    'Conexión muerto con cadena: Arganeo de 31mm y grillete de 36mm grosor'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (254, '26450.7', 'Desgaste máximo: No observado');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    255,
    '26450.7',
    'Tramos reparados: A 4 metros de la boya una reparación de cadena desgastada con grillete.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (256, '26450.7', 'Profundidad fondo natural: 9.8m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    257,
    '26450.7',
    ' Profundidad parte superior muerto:8.6m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    258,
    '26450.7',
    'Muerto enterrado: Semienterrado al 80%'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    259,
    '26450.7',
    'Conexión muerto con cadena: Grillete sin desgaste'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (260, '26450.8', 'Diámetro cadena: 22mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    261,
    '26450.8',
    ' Desgaste máximo: A 5m del contrapeso la cadena tiene un grosor de 17mm'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    262,
    '26450.8',
    'Metros de cadena hasta muerto:16m aproximadamente '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    263,
    '26450.8',
    'Tramos reparados: A 5m de la boya un empalme con grillete de 16mm espesor.'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (264, '26450.8', 'Durmiente: 7m aproximadamente');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (265, '26450.8', 'Profundidad fondo natural: 9.2m ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    266,
    '26450.8',
    'Profundidad parte superior muerto:9.1m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    267,
    '26450.8',
    'Muerto enterrado: al 95% enterrado '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    268,
    '26450.8',
    'Conexión muerto con cadena: Grillete de 31mm grosor y arganeo de 29mm'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (269, '26450.9', 'Diámetro cadena: Cadena nueva ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (270, '26450.9', 'Desgaste máximo: N/A');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    271,
    '26450.9',
    'Durmiente: 6 metros aproximadamente '
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (272, '26450.9', 'Tramos reparados: No');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (273, '26450.9', 'Profundidad fondo natural: 6.3m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    274,
    '26450.9',
    'Profundidad parte superior muerto:5.6m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (275, '26450.9', 'Muerto enterrado: No ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    276,
    '26450.9',
    'Conexión muerto con cadena: Grillete grande a arganeo muerto y pequeño a cadena'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (277, '26451', 'Diámetro cadena: 18mm ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (278, '26451', 'Desgaste máximo: 14mm');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (279, '26451', 'Tramos reparados: No');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (280, '26451', 'Profundidad fondo natural: 7.6m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (281, '26451', 'Muerto enterrado: Si ');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    282,
    '26451',
    'Conexión muerto con cadena: No visible'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    283,
    '25570',
    'Se recomienda pintar la baliza  (Septiembre 2024)'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    284,
    '25555',
    'Hay que cambiar discos linterna en proxima revisión  (Septiembre 2024)'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    285,
    '25555',
    'Se recomienda pintar (septiembre 2024)'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (287, '26450', 'Profundidad fondo natural: 18.9m');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    288,
    '26450',
    'Profundidad parte superior muerto: 17.7m'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (290, '26046.7', 'Muerto de 5Tn');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (291, '26046.9', 'Muerto de 5Tn');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (
    292,
    '26320-a',
    'Figura como responsable OHLA GROUP'
  );
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (293, '26053.5', 'Antigua 26052.5');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (294, '26053.6', 'antigua 26052.7');
