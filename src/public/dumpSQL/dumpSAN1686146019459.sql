...
) ENGINE = InnoDB AUTO_INCREMENT = 1039 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 165 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de observaciones del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de tickets';
...
VALUES
  ('amine', 0.00, 0.00, 0.00, '0', 0.00, 0.00, 0.00);
INSERT INTO
  `lampara` (
    `nif`,
    `altura`,
...
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25470 C.N. Oliva 2 Extremo contradique 38º 55.989\' N 00º 05.559\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25460 C.N. Oliva 1 Extremo dique de abrigo 38º 55.004\' N 00º 05.490\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25460 C.N. Oliva 1 Extremo dique de abrigo 38º 56.004\' N 00º 05.490\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'raul',
    'UPDATE balizamiento',
    '25460 E-0190 Baliza Torre troncopiramidal verde blanca telecontrol2GpD(2)V 7 L0,5 oc1,5 L0,5 oc4,5'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25720 Puerto de Valencia. 1 Extremo dique del Este 39º 26.028\' N 000º 18.271\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25720 Puerto de Valencia. 1 Extremo dique del Este 39º 26.028\' N 000º 17.271\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'admin',
    'UPDATE localizacion',
    '25720 Puerto de Valencia. 1 Extremo dique del Este 39º 26.028\' N 000º 19.271\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'admin',
    'UPDATE documento',
    'Resolucion Valencia a Resolucion provisional emitida por PPEE  sobre una parte del balizamiento'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'admin',
    'INSERT documento',
    'bfaca7ea-32d0-49b7-bb04-61bb6b258ab2.pdf'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'admin',
    'UPDATE inventario',
    'Info actualizada Cargador Bateria 11'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'admin',
    'UPDATE inventario',
    'Info actualizada Cargador Bateria 1'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'adrian',
    'UPDATE balizamiento',
    '26048.3  Boya Elastomero (Espuma polietileno cubierta de poliuretano) RTU 32RpB 0 L0.25 + oc 0.25'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE lampara',
    '26380 4 6 3 BDL-120 (8 coronas) / DES-22 0 0 0'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.500’N 000º 18.670´ W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.500\' N 00º 18.670\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.550\' N 00º 18.675\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.548\' N 00º 18.679\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.548\' N 00º 18.688\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.548\' N 00º 18.748\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.545\' N 00º 18.748\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.538\' N 00º 18.749\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.535\' N 00º 18.750\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.530\' N 00º 18.750\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 26.525\' N 00º 18.750\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    'amine Puerto de Valencia 0 0 39º 27.525\' N 00º 18.750\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'admin',
    'UPDATE ticket',
    'Info actualizada LDR averiada Coger la LDR de sustitución del almacen'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'adrian',
    'UPDATE ticket',
    'Info actualizada fALLA LDR sUSTIRLKVF Y CAMBIR'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'ticket cerrado',
    'fALLA LDR el 2023-06-05 06:32:23'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    '26285 Puerto de Sagunto 1 Extremo Dique de abrigo 39º 38.830\' N 00º 12.321\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'adrian',
    'UPDATE balizamiento',
    '26285 E-0210.75 Baliza BE Metalica Moncada RTU 38 (5 hilos)DR 5 L0,5 oc4,5'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE balizamiento',
    '26285 E-0210.75 Baliza BE Metalica Moncada RTU 38 (5 hilos)DV 5 L0,5 oc4,5'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE localizacion',
    '26450-j Puerto de Sagunto 0 Pantalan Sierra Menera 39° 39.060\' N 00° 12.276\' W'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'adrian',
    'UPDATE ticket',
    'Info actualizada Otra averia Con la descripcion de los trabajos a realizar'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'adrian',
    'UPDATE ticket',
    'Info actualizada FALLA LDR Se sustituye'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'marcos',
    'UPDATE ticket',
    'Info actualizada Revision mayo null'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    '0dv17EsflstJSis0zsUP_79rlkQwy9Dm',
    1686166868,
...
VALUES
  (
    '1JXFiwY2zKTKh2lTd_q-mooXoQRTulnV',
    1686186768,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    '3RBmWLxBoyhxI5dUsPYmMIMjlFwbDtBA',
    1686214327,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    '3WXLQGS-1PJ8Z1cvREwlorEiDH-YnTlW',
    1686171039,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    '3XioHJpu7JyZ9GkdiKDNXaCNSnf3mXzd',
    1686221261,
...
VALUES
  (
    '4QUnJUioS_CgUEPLUWBGLVMSnfCGXQJm',
    1686162618,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    '7noBCjG-fIIc7NWq5MR55yohzkt1Ui9x',
    1686180752,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'FoLcGS-BDDog2t_0wDy_E8ersTN3CY48',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'Hgfu1_fwW8aHUm-qSaiFTBP2bH971POf',
    1686212612,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'JY2P6ybX4VNFFAooC2QCu-1NgWpGmgqn',
    1686214324,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'JmFtQtZSBWjZAF0MJGZ0I1e-jqhiNX3q',
    1686171171,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'JzPJhm53Tre9xlTG-WEvCGcV0wSVYr9Y',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'LzXgPGOUgPHbee93l9vPqy2bMSC64k1w',
    1686166868,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'QZ0-6QaDws79Sa4aNVPc9yfF9iiMmKze',
    1686167797,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'TbhDiLCt0Qt4FZtYLphbMA_-w_CE7f71',
    1686174817,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'VfF2i2EySoAuaWTo3RbRfsa4_oTk7NR_',
    1686208946,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'Wmnx3NoU0tJgOb0jo7xuSv3HTUfGR8XY',
    1686214324,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'Xts16_vAJFxyCbbJY2XlUDIF4bDW15ZY',
    1686167796,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'YgJg2k4N5m7EhJ-VHfdWEEi8MncLq4nL',
    1686179123,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'Yl7I4G7RBHsiDGndOo6ghuh48svoLR7U',
    1686217020,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    '_3h2oqey1WKz99WkRCDbEnpMXII6wZm6',
    1686166865,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'a6Rto4wpZQbFxzq4ireuPWX-bt2Z6p-W',
    1686212613,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'brvO3WfbGKfQEzgN4e6ZSyP39ii5cpH-',
    1686214325,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'cBc5i9KIl9kaxH942itRLOCuIVBmfhrF',
    1686178763,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'cRHqJiqWGO6Si1NEAGzX2zvJ_sPvcUsT',
    1686214327,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'ceunCCdzW34jEGdxU0wH9NG0DJHZAMew',
    1686147382,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'czf18pwFiqiGkMhchO6orqu4vHL5V1iZ',
    1686173386,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'd0InFEDvoxramwVTiKd_iEU72DotNFuh',
    1686166868,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'd7351VEKyQEr3uQiqHfoAdE0a_vELe2N',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'fKY58vCAUE9s5lkACMey-WZmO2skH_5u',
    1686157406,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'g1NkJss3qETffKuSBK4vjKY5wmNeKv6n',
    1686214325,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'goMuwmT0FJB13M1pAKZuFm8F6AsHU4Q4',
    1686214335,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":1}}'
  );
INSERT INTO
  `sessions` (`session_id`, `expires`, `data`)
VALUES
  (
    'hojNrsX0V8SwAepCg5pUlq3KINZ1MfBj',
    1686180760,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'hzBuMuSf30rpyCwKBbMA4uBduYRwR-0G',
    1686214327,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'ieVAIHrNC7MREzHbn0t9E_mTPeotgbu_',
    1686166868,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'izfWfQ5kfPXbfmLmdMA236-Ss9WMpoaf',
    1686178759,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'j0HNiKKJmsnm4XaiCluHQqgayYUKIoXk',
    1686214324,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'lPAQxsj7TBykegHnU9cSmpAtRSWepOiI',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'metPu4FF6nUbx3gw7v7nSM4jvEd7fX5H',
    1686166907,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'nHplcVEu3SR2ecP09r57Ltcx2jsQSuP1',
    1686222846,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'o13bbVQEjm-RuJwD6tqM-juBt8z58thz',
    1686171151,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'oHLCVHXJDG6IhnxnN5vtVTbYxULqAzNn',
    1686216218,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'oxeVRVh0bI_7luvFkpK0Ra9w7mCm1TU5',
    1686166920,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'ptN30zroIeVqKXVs130EeH5cdc2GMfAg',
    1686214327,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'rH9TXaKgFNwb4DNEObIuRWH3gwV4UwiE',
    1686214324,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'rLrwxoElP-5WnRz7kR3Wcc2Np6cp8IBQ',
    1686161088,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":1},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'rRjjvKxU--jQvxzC6mLg13zpJKcrLGIP',
    1686215237,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'riVyLGQIxtlM3wzX5Epdi2nmAm1YygqT',
    1686232419,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":1},\"flash\":{\"success\":[\"Backup de la BBDD realizado correctamente\"]}}'
  );
INSERT INTO
  `sessions` (`session_id`, `expires`, `data`)
VALUES
  (
    'sF_avSV951cxH0henobV8QGU6HJkVUwJ',
    1686166872,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'sHY0BATLlOiuVNt4Df_XMH17dxsEvCJI',
    1686148654,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'sldAhPoJUcuRc-RXSk3lL_U1rMWpO6_W',
    1686166878,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'uBNRaGVH5cQRExR_XWzcr6NxajSjS9fk',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'uaNqMKWY-E-GBH2xgmbgCRsjC1dgcdt0',
    1686214327,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'uriP7QjZKbitnAEdfVCoC4TC2OhotJ1N',
    1686166912,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'vBUFvU1tVFHbB0N6PhzN4zh9NjFHxuxp',
    1686166868,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'vJ9s2FeKG--Ll46a3UTY135lSStEaOC1',
    1686212612,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'xC5i1KMIzHHvuPF687n0EKgLEPljMfoA',
    1686214329,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'xKF2zht1eVGqgBPkWjO_L9kTH-WNHnDm',
    1686180755,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'yFQJfoDitsnzTBcPjuogfYL4QFQnHkl0',
    1686178758,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'yNLG-NYtGlStmt2oeDxd6LSC9eTNJTbt',
    1686214324,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
INSERT INTO
...
VALUES
  (
    'zITKTHkqNzKYTcsEsfVNJ4CVzWOIdPbR',
    1686146606,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'
  );
...
VALUES
  (
    ...
    3,
    'LDR averiada',
    'Coger la LDR de sustitución del almacen',
    '2023-06-04 15:16:04',
    '2023-06-07 07:17:46'
  );
INSERT INTO
...
VALUES
  (
    ...
    4,
    'Otra averia',
    'Con la descripcion de los trabajos a realizar',
    '2023-06-04 15:17:26',
    NULL
  );
INSERT INTO
...
VALUES
  (
    7,
    'admin',
    '$2a$10$kaHECsPMTxeT8B//0BraLOTJIs/A6WevUXo6Dw2z5K68ni0dN8GX.',
    'admin@admin.es',
    'admin',
    'admin',
    NULL
...
VALUES
  (
    8,
    'anonimo',
    '$2a$10$QKlYlt6mDRPGPLBs5Y8RxOiZcngdR8VShjmFkdR6vmRFmeqi15yOi',
    'anonimo@micorreo.es',
    'anonimo',
    '',
    NULL
