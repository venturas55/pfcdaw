...
) ENGINE = InnoDB AUTO_INCREMENT = 166 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de observaciones del balizamiento';
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 10 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tabla de usuarios';
...
VALUES
  ('9999', 0.00, 0.00, 0.00, '0', 0.00, 0.00, 0.00);
INSERT INTO
  `lampara` (
    `nif`,
    `altura`,
...
VALUES
  ('9999', 'Puerto de Valencia', 0, '0', '0', '0');
INSERT INTO
  `localizacion` (
    `nif`,
    `puerto`,
...
VALUES
  (
    'AGA5chKSXwFBMXAdcpY_on6fzaBRMRWa',
    1686289992,
