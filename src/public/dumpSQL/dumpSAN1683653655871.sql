...
CREATE TABLE IF NOT EXISTS `boyas` (
  ...
  `diametro_flotador` float(4, 2) DEFAULT 0.00,
  `altura_castillete` float(4, 2) DEFAULT 0.00,
  `area` float(4, 2) DEFAULT 0.00,
  `peso` float(10, 2) DEFAULT 0.00,
  `diametro_cadena` float(10, 2) DEFAULT 0.00,
  `longitud_cadena` float(10, 2) DEFAULT 0.00
) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'tabla de boyas';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1037 DEFAULT CHARSET = latin1 COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 160 DEFAULT CHARSET = latin1 COMMENT = 'tabla de observaciones del balizamiento';
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: sqlmapfile
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `sqlmapfile` (`data` longtext DEFAULT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 7 DEFAULT CHARSET = latin1 COMMENT = 'tabla de usuarios';
...
VALUES
  (
    ...
    'Balizamiento de Sagunto 17 abril 2015',
    '2023-03-16 11:33:31'
  );
INSERT INTO
  `documentos` (`id_archivo`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    ...
    'Balizamiento Valencia',
    'Resolucion Balizamiento de Valencia 2015',
    '2023-03-16 11:32:15'
  );
INSERT INTO
  `documentos` (`id_archivo`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    ...
    'Resolucion Balizamiento Gandia',
    'Balizamiento de Gandia tras la ampliación del contradique Serpis.',
    '2023-03-16 11:25:42'
  );
INSERT INTO
  `documentos` (`id_archivo`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    ...
    'Provisional Obras Gandia',
    'Provisional de obras del Balizamiento del puerto de Gandia',
    '2023-03-16 11:43:26'
  );
INSERT INTO
  `documentos` (`id_archivo`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    ...
    'Balizamiento Marina Real Juan Carlos I',
    'Balizamiento definitivo  Marina Real Juan Carlos I 2023',
    '2023-03-17 10:28:31'
  );
INSERT INTO
  `documentos` (`id_archivo`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    ...
    'Resolución puente movil',
    'La APV pasa a ser responsable del balizamiento del puente de la marina real.',
    '2023-03-16 11:22:40'
  );
...
VALUES
  (
    ...
    'adrian',
    'LOGIN usuario',
    '1 adrian adeharo@valenciaport.com'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'guillermo',
    'LOGIN usuario',
    '2 guillermo gcasamayor@valenciaport.com'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    ...
    'marcos',
    'LOGIN usuario',
    '3 marcos msaez@valenciaport.com'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
    ...
    'raul',
    'LOGIN usuario',
    '4 raul rrubio@valenciaport.com'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    '0xtDKEZCW7oHYRRE6YfOJdLiN8HfNYmE',
    1683740056,
...
VALUES
  (
    'OLqtsU5zEGiWQKiMNeYqQ_rgmH8cVwd8',
    1682866789,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":1},\"flash\":{\"warning\":[\"No tiene foto de perfil!\"]}}'
  );
INSERT INTO
  `sessions` (`session_id`, `expires`, `data`)
VALUES
  (
    'd1BMJXvY3KGoAVMCTaD2O_Lf1sXEx55h',
    1683737871,
