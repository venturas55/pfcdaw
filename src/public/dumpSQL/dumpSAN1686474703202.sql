...
) ENGINE = InnoDB AUTO_INCREMENT = 1047 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 171 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de observaciones del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de tickets';
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 11 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de usuarios';
...
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
  (1043, '25460', '2023-06-09', 'Se repita el aton');
INSERT INTO
  `mantenimiento` (`id_mantenimiento`, `nif`, `fecha`, `mantenimiento`)
VALUES
...
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (169, '25460', 'Una observacion de pruebaa 2');
INSERT INTO
  `observaciones` (`id_observacion`, `nif`, `observaciones`)
VALUES
  (170, '25460', 'Una observacion modificada');
...
VALUES
  (
    'NVarPs2SO4auv_EjSKCuhVZZkxRuhQix',
    1686561103,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":4},\"flash\":{}}'
  );
INSERT INTO
  `sessions` (`session_id`, `expires`, `data`)
VALUES
  (
    'S3Fqkdswya6fVejRYS8a3JSIpHwIdlOz',
    1686513561,
...
VALUES
  (
    10,
    'anonimo',
    '$2a$10$H4YqIqx5A4sK.2JmTosGLOEj4kfDSRsQua1BlWw2K3m.UyvwQkZNq',
    'anonimo@correo.es',
    'anonimo',
    '',
    NULL
