...
CREATE TABLE IF NOT EXISTS `inventario` (
  ...
  `descripcion` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 83 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de inventario';

# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: inventario_eliminados
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `inventario_eliminados` (
...
) ENGINE = InnoDB AUTO_INCREMENT = 164 DEFAULT CHARSET = utf8mb4 COMMENT = 'tabla de observaciones del balizamiento';
...
VALUES
  (
    9,
    'tecnico',
    '$2a$10$f8YEQFzgd4qVfLk5Mqqw4..s7heJdQe45fNMXc0g8rhe3DzX6PL8K',
    'tecnico@tecnico.es',
    'tecnico',
    'san',
    NULL
...
# ------------------------------------------------------------
# TRIGGER DUMP FOR: copiar_inventario_eliminados
# ------------------------------------------------------------

DROP TRIGGER IF EXISTS copiar_inventario_eliminados;
DELIMITER ;;
CREATE TRIGGER copiar_inventario_eliminados
BEFORE DELETE ON inventario
FOR EACH ROW
BEGIN
  INSERT INTO inventario_eliminados (id, tipo, item,cantidad,fila,columna,descripcion)
  VALUES (OLD.id, OLD.tipo, OLD.item, OLD.cantidad,OLD.fila,OLD.columna,OLD.descripcion);
END;;
DELIMITER ;
